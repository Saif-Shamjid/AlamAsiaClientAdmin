...
const BusManagementTab = ({
  ...
  const [filteredBusOwners, setFilteredBusOwners] = useState(busOwners);

  // Search state for bus selection in update form
  const [busSearchTerm, setBusSearchTerm] = useState("");
  const [filteredBusesForSelection, setFilteredBusesForSelection] =
    useState(buses);
        ...
        (bus) =>
          ...
          (bus.owners &&
            bus.owners.some(
              (owner) =>
                owner.name &&
                owner.name.toLowerCase().includes(busSearchTerm.toLowerCase())
            ))
      );
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-4 sm:p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 border-l-4 border-green-500 transition-transform hover:scale-[1.02]">
            <div className="flex items-center">
              <div className="bg-green-100 p-2 sm:p-3 rounded-xl mr-3 sm:mr-4">
                <FaLink className="text-green-600 text-lg sm:text-xl" />
              </div>
              <div>
                <p className="text-xs sm:text-sm text-gray-500 font-medium">
                  Linked Buses
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 border-l-4 border-amber-500 transition-transform hover:scale-[1.02]">
            <div className="flex items-center">
              <div className="bg-amber-100 p-2 sm:p-3 rounded-xl mr-3 sm:mr-4">
                <FaUnlink className="text-amber-600 text-lg sm:text-xl" />
              </div>
              <div>
                <p className="text-xs sm:text-sm text-gray-500 font-medium">
                  Unlinked Buses
