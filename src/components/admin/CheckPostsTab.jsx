        ...
        <div className="flex items-center mb-8">
          ...
          <div>
            ...
            <p className="text-indigo-600">
              Create and manage checkpoint security accounts
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-xl shadow-md p-5 border-l-4 border-indigo-500">
            <div className="flex items-center">
              ...
              <div>
                <p className="text-sm text-gray-500">Total CheckPosts</p>
          ...
          <div className="bg-white rounded-xl shadow-md p-5 border-l-4 border-green-500">
            <div className="flex items-center">
              ...
              <div>
                <p className="text-sm text-gray-500">Security Role</p>
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-purple-800">
                  {new Set(checkPostMen.map((cp) => cp.checkPostLocation)).size}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="flex items-end">
              <button
                ...
                disabled={!username || !password || !checkPostLocation}
          ...
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
            <div className="border-b border-gray-200 px-6 py-4 flex items-center justify-between">
              <h3 className="text-lg font-medium text-gray-800">
                All CheckPost Accounts
              </h3>
              <span className="text-sm text-gray-500">
                {checkPostMen.length} checkpost accounts
              </span>
            </div>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center">
                          ...
                          <div className="text-sm text-gray-600">
                            {checkPost.checkPostLocation}
                          </div>
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <button
                          onClick={() => onDeleteUser(checkPost._id)}
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-indigo-800">
                About CheckPost Accounts
              </h3>
              <div className="mt-2 text-sm text-indigo-700">
                <p>
                  CheckPost accounts are used by security personnel at
                  checkpoints to verify identities, log entries, and manage
                  access control. Each account is tied to a specific location.
                </p>
              </div>
            </div>
          </div>
